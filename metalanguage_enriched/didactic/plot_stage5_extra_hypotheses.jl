...
english_dataset = Dict([
    ...
    "how_many_1" => 1.0, #  = HowMany(Exact(1))
    "how_many_2" => 1.0, #  = HowMany(Exact(2))
    "how_many_3" => 1.0, #  = HowMany(Exact(3))
    "how_many_4" => 1.0, #  = HowMany(Exact(4))
    "how_many_5" => 1.0, #  = HowMany(Exact(5))
    "how_many_6" => 1.0, #  = HowMany(Exact(6))
    "how_many_7" => 1.0, #  = HowMany(Exact(7))
    "how_many_8" => 1.0, #  = HowMany(Exact(8))
    "how_many_9" => 1.0, #  = HowMany(Exact(9))
    "how_many_10" => 1.0, #  = HowMany(Exact(10))
...
# CP_arrival_time,
# one_arrival_time,
# two_arrival_time) = run_test("english", false, true, true, false)
